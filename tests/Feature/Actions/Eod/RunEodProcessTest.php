...
describe('RunEodProcess', function (): void {
    beforeEach(function (): void {
        $this->action = app(RunEodProcess::class);
    ...
    describe('execute', function (): void {
        it('creates EodProcess and marks as Completed when all steps succeed', function (): void {
            $process = $this->action->execute(new EodProcessData(
        ...
        it('throws when EOD for that date is already completed', function (): void {
            ...
            $this->action->execute(new EodProcessData(
                processDate: $this->processDate,
                performer: $this->user,
            ));
        })->throws(EodAlreadyRunException::class, 'EOD untuk tanggal');
        ...
        })->throws(EodAlreadyRunException::class, 'EOD sedang berjalan');
    ...
    describe('getStepNames', function (): void {
        it('returns all 11 step names', function (): void {
            $steps = $this->action->getStepNames();
