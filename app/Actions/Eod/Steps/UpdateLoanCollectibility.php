...
use App\Actions\Loan\UpdateLoanCollectibility as UpdateLoanCollectibilityAction;
use App\Enums\EodStatus;
use App\Enums\LoanStatus;
use App\Models\EodProcessStep;
use App\Models\LoanAccount;

class UpdateLoanCollectibility implements EodStep
{
    public const STEP_NUMBER = 8;

    public const STEP_NAME = 'Collectibility Update';

    public function __construct(
        private UpdateLoanCollectibilityAction $updateLoanCollectibility,
    ) {}
    ...
    public function handle(EodPipelinePayload $payload, \Closure $next): EodPipelinePayload
    {
        ...
        try {
            ...
            foreach ($accounts as $account) {
                $this->updateLoanCollectibility->execute($account);
                $count++;
            }
